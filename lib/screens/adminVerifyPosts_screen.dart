...
class ApprovePosts extends StatefulWidget {
  @override
  _ApprovePostsState createState() => _ApprovePostsState();
}

class _ApprovePostsState extends State<ApprovePosts> {
  ...
  void initState() {
    ...
    crudMethods.getUnverifiedPostsData().then((result) {
      setState(() {
